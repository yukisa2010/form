...
class FromValidator {
  ...
  valid() {
    ...
    if (this.titleStr.length < this.config.title.minLength) {
      this.errors.push(`タイトルは${this.config.title.minLength}以上で入力してください`)
    } else if (this.titleStr.length > this.config.title.maxLength) {
      this.errors.push(`タイトルは${this.config.title.maxLength}以下で入力してください`)
    } 
    
    if (this.descStr.length < this.config.desc.minLength) {
      this.errors.push(`タイトルは${this.config.desc.minLength}以上で入力してください`)
    } else if(this.descStr.length > this.config.desc.maxLength) {
      this.errors.push(`タイトルは${this.config.desc.maxLength}以下で入力してください`)
    }
